		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comboschcamera-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comboschcamera-display": {
								"semanticObject": "comboschcamera",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.bosch.camera",
									"url": sap.ui.require.toUrl("com/bosch/camera")
								}
							}
						}
					}
